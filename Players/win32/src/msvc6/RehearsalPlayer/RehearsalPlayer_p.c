...
/* Object interface: IAuStage, ver. 0.0,
   GUID={0x89CF893A,0x2A69,0x48A4,{0x91,0x4C,0xA3,0x42,0x29,0xE3,0xD1,0x60}} */
...
CINTERFACE_PROXY_VTABLE(13) _IAuStageProxyVtbl = 
{
    &IAuStage_ProxyInfo,
    &IID_IAuStage,
    ...
    (void *)-1 /* IAuStage::init */ ,
    (void *)-1 /* IAuStage::run */ ,
    (void *)-1 /* IAuStage::cleanup */ ,
    (void *)-1 /* IAuStage::isRunning */ ,
    (void *)-1 /* IAuStage::setDigitalWorkprint */ ,
    (void *)-1 /* IAuStage::startPlayer */
};
